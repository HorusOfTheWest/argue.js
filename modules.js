  ...
  syllogism: {
    slides: {
      ...
      slide5: {
        ...
        explainer:
          "This example shows us the way an argument can be logically correct, but false. The logic is correct. Even in this example, if it was true that cats could fly, and that Muffins was a cat, then it would have to be true that Muffins could fly.",
      },
      slide6: {
        example: `All cats can fly
          Muffins in a cat
          Therefore, Muffins can fly`,
        explainer:
          "This is the difference between validity and soundness. If an argument is logically correct, it is valid. In a valid deductive argument, the premises being true means the conclusion must be true. But this does not guarantee that the premises are in fact, true. ",
      },
      slide7: {
      ...
      slide28: {
        ...
        explainer: `Hint: In a syllogistic argument, the conditions must both be true for the conclusion to be true. In this code argument, does it follow that if the conditions are true that the conclusion is false?`,
      },
      slide29: {
        example: `If (Men.hasOwnProperty('mortal')
          && Socrates instanceof Men ) { 
